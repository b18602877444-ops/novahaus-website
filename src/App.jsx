...
import { ComparePlansPage, ManagedAiGrowthPage, PricingPage } from './components/CommercialCenterPage.jsx'
      ...
      <div className="hero-grid page-shell">
        <div className="hero-copy">
          <div>
            ...
            <motion.p className="hero-description" initial={reduceMotion ? false : { opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={reduceMotion ? { duration: 0 } : { duration: 0.6, delay: 0.62, ease: heroEase }}>NOVAHAUS is your AI Growth Operations Team. Build the growth capabilities your business needs without hiring and managing a full in-house content, brand, community and digital operations team.</motion.p>
...
Object.assign(routeMeta, {
  ...
  '/products': { title: 'AI Business Growth Services | NOVAHAUS', description: 'Explore NOVAHAUS Business Strategy, Brand & Commercial Assets, Media & Content, AI Systems and Managed Growth services.', indexable: true },
  '/pricing': { title: 'AI Growth Services Pricing Malaysia | NOVAHAUS', description: 'Explore AI website pricing, AI Sales Agent pricing, automation services and managed AI growth plans from NOVAHAUS in Malaysia.', indexable: true },
  ...
  '/growth-assessment': { title: 'Free AI Business Growth Assessment | NOVAHAUS', description: 'Answer 12 focused questions and receive one recommended NOVAHAUS Monthly Operations Department for your next useful business move.', indexable: true },
