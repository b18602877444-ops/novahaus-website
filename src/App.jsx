...
Object.assign(routeMeta, {
  ...
  '/managed-ai-growth': { title: 'Managed AI Growth Services Malaysia | NOVAHAUS', description: 'Explore managed AI growth services for monitoring, maintenance, AI optimisation, conversion improvement and business automation support.', indexable: true },
  '/delivery-scope': { title: 'AI Services Delivery Scope Malaysia | NOVAHAUS', description: 'Explore NOVAHAUS AI website, AI Sales Agent, automation and managed growth delivery scope, responsibilities and custom quotation boundaries.', indexable: true },
