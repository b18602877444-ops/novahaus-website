...
export const growthOperationsPlans = [
  {
    ...
    name: 'AI Content Operations Department',
    ...
    aiSalesSummary: 'The AI Content Operations Department provides a defined monthly content rhythm for project teams, creators and SMEs that need consistent approved promotional content.',
  ...
  },
  {
    ...
    name: 'AI Brand Operations Department',
    ...
    aiSalesSummary: 'The AI Brand Operations Department supports founders and personal brands with defined monthly narrative, content, profile and commercial-asset capacity without promising virality or sales.',
  ...
  },
  {
    ...
    name: 'AI Community Operations Department',
    ...
    aiSalesSummary: 'The AI Community Operations Department provides defined monthly content, knowledge and community-support capacity for legitimate communities without financial promises or account-management claims.',
  ...
  },
  {
    ...
    name: 'AI Growth Operations Department',
    label: 'Recommended for Project Teams',
    monthlyPrice: 'Starting from USD 5,000 / month',
    onboardingFee: 'Starting from USD 4,000',
    bestFor: 'Established project teams and businesses that need a broader outsourced AI growth operations function.',
    monthlyStandardCapacity: [
      ...
      'AI Sales knowledge optimisation',
    ...
    aiSalesSummary: 'The AI Growth Operations Department is a coordinated flagship service for established teams that need defined content, commercial-asset, AI-system and customer-journey capacity without describing the work as unlimited.',
