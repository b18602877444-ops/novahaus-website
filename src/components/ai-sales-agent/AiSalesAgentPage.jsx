...
function AiSalesAgentPage() {
  ...
  return <div className="sales-agent-page"><header className="sales-agent-header"><a href="/" aria-label="NOVAHAUS home"><BrandLogo className="sales-agent-logo" /></a><div><span>NOVAHAUS AI Sales Agent</span><small>Private preview · Mock mode</small></div><button type="button" className="sales-agent-reset" onClick={handleReset}>Reset conversation</button></header><main className="sales-agent-main">
