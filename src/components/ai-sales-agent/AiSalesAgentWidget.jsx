...
function AiSalesAgentWidget() {
  ...
  return <div className="ai-sales-widget">
    ...
    {isOpen && !isMinimized && <section id="novahaus-ai-sales-widget-panel" className="ai-sales-widget-panel" role="dialog" aria-label="NOVAHAUS AI Sales Consultant">
      <header className="ai-sales-widget-header"><div className="ai-sales-widget-heading"><BrandLogo className="ai-sales-widget-logo" /><span><strong>NOVAHAUS AI</strong><small>AI Sales Consultant</small></span></div><div className="ai-sales-widget-controls"><button type="button" aria-label="Minimize NOVAHAUS AI" onClick={() => setIsMinimized(true)}>−</button><button type="button" aria-label="Close NOVAHAUS AI" onClick={() => setIsOpen(false)}>×</button></div></header>
