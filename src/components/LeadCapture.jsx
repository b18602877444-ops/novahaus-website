...
function LeadCapture({ onSubmit }) {
  ...
  if (submitted) {
    return <div className="lead-capture-success" role="status" aria-live="polite"><span>Thank you.</span><p>Your request has been saved in this browser. NOVAHAUS can review the context once a connected follow-up channel is in place.</p></div>
  }
