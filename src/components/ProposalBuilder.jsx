...
function ProposalBuilder() {
  ...
  const update = (next) => { const normalised = { ...next, investment: { ...next.investment, currency: 'USD' } }; setProposal(normalised); setDirty(true); setNotice('') }
