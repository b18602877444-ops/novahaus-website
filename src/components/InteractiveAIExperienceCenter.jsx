...
const experienceItems = [
  {
    ...
    description: 'Talk through the business in your own words and leave with a clearer view of the most relevant next move.',
    points: ['Clarify the business context', 'Surface the central constraint', 'Map relevant capabilities', 'Choose the next step'],
  ...
  },
  {
    ...
    description: 'Turn the context you have gathered into a clear working scope and considered recommendation.',
    points: ['Organise requirements', 'Select a suitable direction', 'Shape scope and priorities', 'Prepare a proposal draft'],
